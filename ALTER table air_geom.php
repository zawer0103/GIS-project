...
if (is_array($cities) || is_object($cities))
{
  ...
  // ".$selectedCity.".".$selectedCity."_
    ...
    $alter =" ALTER TABLE ".$selectedCity.".".$selectedCity."_cable_air_cable_geom ADD COLUMN cable_description varchar(50);";
    $result=pg_query($postgres, $alter); 

       $alter2 ="ALTER TABLE ".$selectedCity.".".$selectedCity."_cable_air ALTER COLUMN cable_type SET DEFAULT 'optic';"; 
    $result=pg_query($postgres, $alter2); 

      /*    $alter2 ="ALTER TABLE ".$selectedCity.".".$selectedCity."_cable_air ALTER COLUMN cable_type DROP DEFAULT;"; 
    $result=pg_query($postgres, $alter2); */

  
//ALTER TABLE fastiv.fastiv_cable_air_cable_geom ADD COLUMN cable_description varchar(50); // работает

//ALTER TABLE fastiv.fastiv_cable_air ALTER COLUMN cable_type SET DEFAULT 'optic'::varchar; // работает
//ALTER TABLE kiev.kiev_cable_air_cable_geom ADD COLUMN total_cable_length varchar(50);
